...
Use the following information to understand how to create your document:
    - create your file under `thoughts/shared/handoffs/audc-XXXX/YYYY-MM-DD_HH-MM-SS_audc-ZZZZ_description.md`, where:
        - YYYY-MM-DD is today's date
        - HH-MM-SS is the hours, minutes and seconds based on the current time, in 24-hour format (i.e. use `13:00` for `1:00 pm`)
        - audc-XXXX is the ticket number (replace with `general` if no ticket)
        - audc-ZZZZ is the ticket number (omit if no ticket)
        - description is a brief kebab-case description
    - Run the `scripts/ai/spec_metadata.sh` script to generate all relevant metadata
    - Examples:
        - With ticket: `2025-01-08_13-55-audc-2166_wallet-integration.md`
        - Without ticket: `2025-01-08_13-55-22_web3-wallet-connection.md`
...
# Handoff: audc-XXXX {very concise description}
...
Ask the user to review and approve the document. if they request any changes, you should make them and ask for approval again. Once the user approves the documents, you should sync the thoughts directory to save the document.
...
```bash
/resume_handoff thoughts/shared/handoffs/FSC-2166/2025-01-08_13-44-55_FSC-2166_create-context-compaction.md
```
